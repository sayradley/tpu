...
MEAN_RGB = [181.85114, 177.5449, 177.9233 ]
STDDEV_RGB = [69.32637, 72.72933, 71.194016]
...
def get_lr_schedule(train_steps, num_train_images, train_batch_size):
  ...
  return [  # (multiplier, epoch to start) tuples
      ...
      (0.1, np.floor(10 / 60 * train_epochs)),
      (0.01, np.floor(20 / 60 * train_epochs)),
      (0.001, np.floor(30 / 60 * train_epochs))
  ]
